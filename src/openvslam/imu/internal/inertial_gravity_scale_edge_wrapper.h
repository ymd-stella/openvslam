#ifndef OPENVSLAM_IMU_INTERNAL_GRAVITY_SCALE_EDGE_WRAPPER_H
...
class inertial_gravity_scale_edge_wrapper {
public:
    inertial_gravity_scale_edge_wrapper() = delete;

    inertial_gravity_scale_edge_wrapper(const std::shared_ptr<preintegrated>& imu_preintegrated,
...
inline inertial_gravity_scale_edge_wrapper::inertial_gravity_scale_edge_wrapper(
...
inline bool inertial_gravity_scale_edge_wrapper::is_inlier() const {
    return edge_->level() == 0;
}

inline bool inertial_gravity_scale_edge_wrapper::is_outlier() const {
    return edge_->level() != 0;
}

inline void inertial_gravity_scale_edge_wrapper::set_as_inlier() const {
    edge_->setLevel(0);
}

inline void inertial_gravity_scale_edge_wrapper::set_as_outlier() const {
    edge_->setLevel(1);
}
...
#endif // OPENVSLAM_IMU_INTERNAL_GRAVITY_SCALE_EDGE_WRAPPER_H
